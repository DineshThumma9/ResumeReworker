...
export function AuthForm({
  ...
  const displayEmail = email.trim() || "resume-reworker.ai";

  return (
    <form onSubmit={handleSubmit} className="contents">
      <div className="font-['EB_Garamond'] text-[20px] font-semibold tracking-wider uppercase text-[#1a1a1a] text-center">
        {displayName}
      </div>
      ...
      {[
        ...
        <div key={f.lbl} className="flex items-baseline gap-2 mb-4">
          <div className="font-['EB_Garamond'] text-[15px] font-medium text-[#1a1a1a] whitespace-nowrap w-[80px]">
            {f.lbl}
          </div>
      ...
      <div className="flex items-center gap-2 mb-1">
        <div className="font-['EB_Garamond'] text-[15px] font-medium text-[#1a1a1a] min-w-[80px]">
          Auth
        </div>
        <div className="font-['EB_Garamond'] text-[15px] text-[#ccc] shrink-0">
          :
