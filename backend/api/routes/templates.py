...
from schemas.schema import TemplateOut, PaginatedTemplateResponse
...
async def create_template(body: TemplateCreate, current_user: CurrentUser, db: DB, background_tasks: BackgroundTasks):
...
async def update_template(template_id: int, body: TemplateUpdate, current_user: CurrentUser, db: DB, background_tasks: BackgroundTasks):
